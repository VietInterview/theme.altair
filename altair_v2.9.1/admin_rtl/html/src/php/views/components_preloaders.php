<?php defined('safe_access') or die('Restricted access!'); ?>
    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="md-card uk-margin-medium-bottom" id="preloader_dynamic">
                <div class="md-card-content">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-large-2-3">
                            ...
                            <button class="md-btn" id="show_preloader_custom">Show custom</button>
<pre class="line-numbers uk-margin-top"><code class="language-javascript">// show preloader
altair_helpers.content_preloader_show('md');
// hide preloader
altair_helpers.content_preloader_hide();
// show preloader
altair_helpers.content_preloader_show('md','danger','#preloader_dynamic',64,64);</code></pre>
                        </div>
                    </div>
                </div>
            </div>
