                                        ...
                                        <div class="uk-overflow-container">
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="form_section" id="options_section_colors">
                                                        ...
                                                        <td class="uk-text-right uk-text-middle">
                                                            <a href="#" class="btnSectionClone" data-section-clone="#options_section_colors"><i class="material-icons md-24">&#xE145;</i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="uk-overflow-container">
                                            <table class="uk-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="form_section" id="options_section_internal_memory">
                                                        ...
                                                        <td class="uk-text-right uk-text-middle">
                                                            <a href="#" class="btnSectionClone" data-section-clone="#options_section_internal_memory"><i class="material-icons md-24">&#xE145;</i></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
